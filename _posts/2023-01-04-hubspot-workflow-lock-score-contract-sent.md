---
layout: single
title: "How to Lock the Meddicc Score with a HubSpot Workflow"
categories: blog
tags:
  - HubSpot
  - workflow
...
excerpt: Learn how to use a HubSpot workflow and the Meddicc Score API to automatically lock the score when a deal reaches Contract Sent.
header:
